...
class Config(object):  
  ...
  # AWS SNS topic
  AWS_SNS_ARN_TOPIC = 'arn:aws:sns:us-east-1:127134666975:songyuanzheng_a12_job_requests'
  ...
  # AWS SQS queue 
  AWS_SQS_QUEUE_URL = 'https://sqs.us-east-1.amazonaws.com/127134666975/songyuanzheng_a12_job_requests'
  # AWS SQS queues
